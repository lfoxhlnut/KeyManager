...
func _on_save_sub_btn_pressed(op: String) -> void:
	match op:
		"save", "load":
		...
		_:
			print_debug("unexpected op: ", op)


func _on_item_sub_btn_pressed(op: String) -> void:
	match op:
		"add":
...
func _on_class_sub_btn_pressed(op: String) -> void:
	match op:
		"add":
